...
export default function HeroSec() {
    return (
        <div className='min-h-screen grid 2xl:grid-cols-2 xl:grid-cols-2 lg:grid-cols-1 py-7 x-container gap-5'>
            <div>
                <h1 className='2xl:text-7xl xl:text-6xl text-6xl mt-16 tracking-widest font-semibold'>
                    <Balancer>
                ...
                <h1 className='2xl:text-7xl xl:text-6xl text-6xl tracking-widest font-semibold'>
                    <Balancer>
                        <span className='hero-gradient'>
                            Better Results
                        </span>
                ...
                <p className='text-white text-left text-lg font-medium text-opacity-90 py-3'>
                    <Balancer>
