        ...
        <div className="bg-white py-24 x-container">
            <div className="grid gap-3 3xl:grid-cols-7 2xl:grid-cols-7 xl:grid-cols-7 lg:grid-cols-7 md:grid-cols-1 sm:grid-cols-1 xs:grid-cols-1 grid-cols-1">
                <div className="col-span-3 flex flex-col 3xl:justify-between 2xl:justify-between xl:justify-between lg:justify-between md:justify-center justify-center 3xl:h-96 2xl:h-96 xl:h-96 lg:h-96 md:h-full sm:h-full h-full gap-4">
                    <h2 className="3xl:text-7xl 2xl:text-7xl xl:text-7xl lg:text-5xl md:text-5xl sm:text-5xl xs:text-3xl text-3xl 3xl:text-left 2xl:text-left xl:text-left lg:text-left md:text-center">
                        <Balancer>
                ...
                <div className="col-span-4 flex flex-col 3xl:justify-between 2xl:justify-between xl:justify-between lg:justify-between md:justify-center justify-center 3xl:items-start 2xl:items-start xl:items-start lg:items-start md:items-center 3xl:h-96 2xl:h-96 xl:h-96 lg:h-96 md:h-full sm:h-full h-full">
